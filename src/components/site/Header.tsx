      ...
      >
        <div className="container-luxe flex items-center justify-between h-[76px]">
          <Link to="/" className="flex items-center gap-3 group" aria-label="SS Architects & Interiors — home">
            <span className="font-inter font-medium text-xl sm:text-2xl md:text-[28px] lg:text-[32px] xl:text-[35px] tracking-tight leading-none whitespace-nowrap">
          ...
          >
            <div className="container-luxe h-full flex flex-col text-[#F6F6F4]">
              <div className="flex items-center justify-between h-[76px]">
                <span className="font-inter font-medium text-2xl sm:text-3xl tracking-tight">SS Architects <span className="text-accent lowercase">&amp;</span> Interiors</span>
